...
@section('content')
   ...
   <img src="{{url('/')}}/assets/images/cake111.jpg" alt="Banner Image">
			...
			<div class="row">
				...
				<div class="product_right_sec">
					<div class="row">
						...
						<div class="flower_box">
								...
								<div class="cake_img flower_imgs">
                                 <?php if(!empty($product->cat_image)) {   ?>
                                 	<a href="{{url('/')}}/cakes/{{$product->cat_slug}}">
									<img src="{{url('/')}}/uploads/categories/{{$product->id}}/{{$product->cat_image}}" alt="{{$product->cat_name}}"></a>
						...
						<div class="flower_heading"><h3><a href="{{url('/')}}/cakes/{{$product->cat_slug}}">{{$product->cat_name}}</a></h3>
						</div>
			            </div>
						 @endforeach
                        	</div>
