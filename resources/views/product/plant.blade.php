...
@section('content')
   ...
   <img src="{{url('/')}}/public/assets/images/plants_b.jpg">
    <?php }  else { ?>
	...
	<div class="container">
		<div class="inner_breadcums">
			<div class="inner_left">
               {!! Breadcrumbs::render('plant',$catname) !!}
				<!-- <ul>
				  <li><a href="#">Home</a></li>
			...
			<li><span>Showing {{ $products->lastItem() }} out of  {{$products->total()}} Gifts
				   		 ...
				   		 <input type="hidden" name="type" value="plants" id="type">
		...
		<div class="products_sec">
			<div class="row">
				@include('sidebar')
               @if(count($products)>0)
				<div class="col-xs-12 col-sm-9 product_right_sec" id="old_div">
						...
						<div class="col-xs-12 col-sm-3 prdct_box">
							...
							<div class="wk_prdct_inner">
								<div class="wk_prdct_img">
									<a href="{{url('/')}}/plant/{{$product->slug}}"><img src="<?php echo $image->productMainImage($product->id); ?>"></a>
								</div>
									...
									<div class="hover_ul">
										<ul>
										  ...
										  <li><a href="{{url('/')}}/add-to-wishlist/{{$product->id}}">
										  	<img class="black_img" src="{{url('/')}}/assets/images/heart_black.png">
										  	<img class="white_img" src="{{url('/')}}/assets/images/heart_white.png">
										  </a></li>
                                             @endif
										 <!--  <li><a href="{{url('/')}}/plant/{{$product->slug}}">
										  	<img class="black_img" src="{{url('/')}}/assets/images/eye_black.png">
										  	<img class="white_img" src="{{url('/')}}/assets/images/eye_white.png">
										  </a></li> -->
										  ...
										  <li><form method="post" action="{{url('/')}}/add-to-cart">
										  	...
										  	<button type="submit">
										  	<img class="black_img" src="{{url('/')}}/assets/images/cart_black.png">
										  	<img class="white_img" src="{{url('/')}}/assets/images/cart_white.png">
										  </button>
										  	</form></li>

										</ul>
									</div>
									<h3 title="{{$product->name}}"><a href="{{url('/')}}/plant/{{$product->slug}}">{{$product->name}}</a></h3>
