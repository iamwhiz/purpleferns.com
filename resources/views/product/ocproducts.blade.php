	...
	<div class="container">
		<div class="inner_breadcums">
			<div class="inner_left">
             {!! Breadcrumbs::render('occasions',$ocname) !!}
			...
			<div class="col-xs-12 col-sm-3 product_sidebar">
					<div class="product_sidebar_inner">
						...
						<ul>
							 ...
							 <li><a href="#">By Occasions </a><span><img src="{{url('/')}}/public/assets/images/arrow_down.png"></span>
						  	<ul>
						  		@foreach($side_cat as $s_cat)

						  		<li><a href="{{url('/')}}/occasion/{{$s_cat->oc_slug}}">{{$s_cat->oc_name}}</a></li>
